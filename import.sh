...
bitcoind -daemon -printtoconsole -rpcbind=0.0.0.0 -rpcallowip=0.0.0.0/0 -txindex=1 -datadir=/data/.bitcoin
...
bitcoin-cli -datadir=/data/.bitcoin loadtxoutset /utxo-snapshot-height-840000.dat
